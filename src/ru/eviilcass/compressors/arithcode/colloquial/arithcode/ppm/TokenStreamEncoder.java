package ru.eviilcass.compressors.arithcode.colloquial.arithcode.ppm;
...
/** ru.eviilcass.compressors.Model of a sequence of tokens.  Limited to
...
public final class TokenStreamEncoder {
    ...
    /** ru.eviilcass.compressors.Model for the sequence of tokens, encoded as bytes, making up
     * the token stream.
     */
