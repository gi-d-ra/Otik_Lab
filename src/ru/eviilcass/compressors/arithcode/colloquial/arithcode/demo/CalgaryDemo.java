package ru.eviilcass.compressors.arithcode.colloquial.arithcode.demo;

import com.colloquial.arithcode.ppm.*;
...
public class CalgaryDemo {
    ...
    /**
     * Run the demo ru.eviilcass.compressors on the specified file.
     */
